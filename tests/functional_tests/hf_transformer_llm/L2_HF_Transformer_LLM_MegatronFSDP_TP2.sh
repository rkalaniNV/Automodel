...
<<<<<<< HEAD:tests/functional_tests/hf_transformer_llm/L2_HF_Transformer_LLM_nvFSDP_TP2.sh
...
>>>>>>> 68176f8 (rename nvFSDP to MegatronFSDP):tests/functional_tests/hf_transformer_llm/L2_HF_Transformer_LLM_MegatronFSDP_TP2.sh
