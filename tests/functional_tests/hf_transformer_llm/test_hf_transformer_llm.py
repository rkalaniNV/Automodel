...
HF_TRANSFORMER_LLM_NVFSDP_TP2_HF_TPPLAN_FILENAME = "L2_HF_Transformer_LLM_nvFSDP_TP2_HF_TPPLAN.sh"
...
class TestHFTransformerLLM:
    ...
    @pytest.mark.pleasefixme
    def test_hf_transformer_llm_nvfsdp_tp2_hf_tpplan(self):
        run_test_script(TEST_FOLDER, HF_TRANSFORMER_LLM_NVFSDP_TP2_HF_TPPLAN_FILENAME)
