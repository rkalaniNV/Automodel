...
<<<<<<< HEAD:tests/functional_tests/hf_transformer_finetune/L2_HF_Transformer_PEFT_nvfsdp.sh
...
>>>>>>> 68176f8 (rename nvFSDP to MegatronFSDP):tests/functional_tests/hf_transformer_finetune/L2_HF_Transformer_PEFT_megatronfsdp.sh
