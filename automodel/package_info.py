...
__description__ = 'NeMo Automodel - Delivers zero-day integration with Hugging Face models, automating fine-tuning and pretraining with built-in parallelism, custom-kernels and optimized recipes'
__license__ = 'Apache2'
